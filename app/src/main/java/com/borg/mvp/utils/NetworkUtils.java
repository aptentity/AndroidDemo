...
/**
 * Created by Gulliver(feilong) on 16/1/6.
 */
public class NetworkUtils {
    ...
    public static final byte NETWORK_CLASS_WIFI = 2;
    public static final byte NETWORK_CLASS_UNAVAILABLE = 127;
    /**
     * 获取网络状态
     * @return
     */
    ...
    private static byte getNetworkClassByType(int networkType) {
        switch (networkType) {
