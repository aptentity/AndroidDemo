...
package com.borg.androidemo.notification;
...
import com.borg.androidemo.activity.FirstActivity;

/**
 * 测试NotificationListenerService，用来读取Notification
 * by zfl
 * 继承于NotificationListenerService，且在Manifest中声明相应的权限
 * 需要4.3以上
 * 需要考虑该service被kill的情况
 */
public class NotificationListenerTestActivity extends Activity {

    private static final String TAG = "SevenNLS";
    private static final String TAG_PRE = "["+FirstActivity.class.getSimpleName()+"] ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notification_listener_test);
