...
public class AndroidChartsActivity extends Activity {
	...
	private void initMASlipCandleStickChart() {
		...
		maslipcandlestickchart.setOnTouchGestureListener(new OnTouchGestureListener(){
			 ...
			 * @param touchable
			 * @param event 
			 * @see cn.limc.OnTouchGestureListener#onTouchDown(cn.limc.ITouchable, android.view.MotionEvent)
			 */
			@Override
			 ...
			 * @param touchable
			 * @param event 
			 * @see cn.limc.OnTouchGestureListener#onTouchMoved(cn.limc.ITouchable, android.view.MotionEvent)
			 */
			@Override
			 ...
			 * @param touchable
			 * @param event 
			 * @see cn.limc.OnTouchGestureListener#onTouchUp(cn.limc.ITouchable, android.view.MotionEvent)
			 */
			@Override
